...
classdef MCPhase < qclab.qgates.QMultiControlledGate
  ...
  methods
    ...
    function objprime = ctranspose( obj )
     ...
     %> Makes this multi-controlled phase gate fixed.
    function makeFixed(obj)
      obj.gate_.makeFixed();
    end
    
    %>  Makes this multi-controlled phase gate variable.
    ...
    %> Returns the cosine \f$\cos(\theta)\f$ of this multi-controlled phase
    %> gate.
    function cos = cos(obj)
      cos = obj.gate_.cos;
    end
    
    %> Returns the sine \f$\sin(\theta)\f$ of this multi-controlled phase 
    %>gate.
    function sin = sin(obj)
      sin = obj.gate_.sin;
    end
    
    %> Updates the angle of this multi-controlled phase gate
    ...
    %> Copy of 1-qubit gate of multi-controlled phase gate
