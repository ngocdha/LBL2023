%> @file MCY.m
%> @brief Implements MCH class
% ==============================================================================
%> @class MCY
%> @brief Multi-Controlled Hadamard gate.
%> 
%>
% (C) Copyright Daan Camps and Roel Van Beeumen 2021.  
% ==============================================================================
classdef MCH < qclab.qgates.QMultiControlledGate
  properties (Access = protected)
    %> Property storing the 1-qubit Hadamard gate of this multi-qubit controlled 
    %> gate.
    gate_(1,1)  qclab.qgates.Hadamard
  end
  
  methods
    
    function obj = MCH(controls, target, controlStates)
      if nargin < 3, controlStates = ones(size(controls)) ; end
      obj@qclab.qgates.QMultiControlledGate(controls, controlStates );
      obj.gate_ = qclab.qgates.Hadamard( target );
    ...
    function [bool] = equals(obj, other)
      bool = false ;
      if isa(other,'qclab.qgates.Hadamard') && ...
